 ...
 * @constructor
 */
Blockly.FieldButton = function(value, opt_config) {
  /**
   ...
   * @private
   */
  this.tooltip_ = opt_config.tooltip;
 ...
 */
Blockly.FieldButton.prototype.name = undefined;
 ...
 * @package
 */
Blockly.FieldButton.prototype.disposed = false;

/**
 * Maximum characters of text to display before adding an ellipsis.
 * @type {number}
 */
Blockly.FieldButton.prototype.maxDisplayLength = 25;
 ...
 * @protected
 */
Blockly.FieldButton.prototype.sourceBlock_ = null;
 ...
 * @protected
 */
Blockly.FieldButton.prototype.isDirty_ = true;
 ...
 * @protected
 */
Blockly.FieldButton.prototype.visible_ = true;
 ...
 * @protected
 */
Blockly.FieldButton.prototype.clickTarget_ = null;
 ...
 * @protected
 */
Blockly.FieldButton.prototype.getText_;
 ...
 * @protected
 */
Blockly.FieldButton.prototype.showEditor_;

/**
 * Non-breaking space.
 * @const
 */
Blockly.FieldButton.NBSP = '\u00A0';
 ...
 * @protected
 */
Blockly.FieldButton.prototype.configure_ = function(config) {
  ...
  this.clickHandler_ = config.clickHandler;
  if(config.textOffset){
    this.textOffset_ = config.textOffset;//自定义调整文字或图标的偏移
  }
 ...
 */
Blockly.FieldButton.prototype.setSourceBlock = function(block) {
 ...
 *     provider.
 */
Blockly.FieldButton.prototype.getConstants = function() {
 ...
 */
Blockly.FieldButton.prototype.getSourceBlock = function() {
...
Blockly.FieldButton.prototype.init = function() {
  ...
  Blockly.utils.dom.addClass(this.fieldGroup_, 'field-button');
 ...
 * @package
 */
Blockly.FieldButton.prototype.initView = function() {
 ...
 * @package
 */
Blockly.FieldButton.prototype.initModel = function() {
};
 ...
 * @protected
 */
Blockly.FieldButton.prototype.createBorderRect_ = function() {
 ...
 * @protected
 */
Blockly.FieldButton.prototype.createTextElement_ = function() {
 ...
 * @protected
 */
Blockly.FieldButton.prototype.bindEvents_ = function() {
 ...
 */
Blockly.FieldButton.prototype.updateEditable = function() {
 ...
 */
Blockly.FieldButton.prototype.isClickable = function() {
 ...
 */
Blockly.FieldButton.prototype.isCurrentlyEditable = function() {
 ...
 */
Blockly.FieldButton.prototype.isSerializable = function() {
 ...
 */
Blockly.FieldButton.prototype.isVisible = function() {
 ...
 * @package
 */
Blockly.FieldButton.prototype.setVisible = function(visible) {
 ...
 */
Blockly.FieldButton.prototype.setValidator = function(handler) {
 ...
 */
Blockly.FieldButton.prototype.getValidator = function() {
 ...
 *  functions instead.
 */
Blockly.FieldButton.prototype.classValidator = function(text) {
  return text;
};
 ...
 */
Blockly.FieldButton.prototype.callValidator = function(text) {
 ...
 * @package
 */
Blockly.FieldButton.prototype.applyColour = function() {
 ...
 * @protected
 */
Blockly.FieldButton.prototype.render_ = function() {
 ...
 * @package
 */
Blockly.FieldButton.prototype.showEditor = function(opt_e) {
  if (this.isClickable()) {
 ...
 * @deprecated May 2019  Use Blockly.FieldButton.updateSize_() to force an update
...
Blockly.FieldButton.prototype.updateWidth = function() {
  console.warn('Deprecated call to updateWidth, call' +
    ' Blockly.FieldButton.updateSize_ to force an update to the size of the' +
 ...
 * @protected
 */
Blockly.FieldButton.prototype.updateSize_ = function(opt_margin) {
  ...
  if(this.textOffset_){
    this.positionTextElement_(this.textOffset_.x, contentWidth);  
  }else{
 ...
 * @protected
 */
Blockly.FieldButton.prototype.positionTextElement_ = function(xOffset, contentWidth) {
  if (!this.textElement_) {
    return;
  }
  var constants = this.getConstants();
 ...
 * @protected
 */
Blockly.FieldButton.prototype.positionBorderRect_ = function() {
  if (!this.borderRect_) {
    return;
  }
 ...
 */
Blockly.FieldButton.prototype.getSize = function() {
  if (!this.isVisible()) {
 ...
 * @package
 */
Blockly.FieldButton.prototype.getScaledBBox = function() {
  if (!this.borderRect_) {
 ...
 * @protected
 */
Blockly.FieldButton.prototype.getDisplayText_ = function() {
  var text = this.getText();
  if (!text) {
    // Prevent the field from disappearing if empty.
    return Blockly.FieldButton.NBSP;
  }
  ...
  text = text.replace(/\s/g, Blockly.FieldButton.NBSP);
 ...
 */
Blockly.FieldButton.prototype.getText = function() {
  if (this.getText_) {
 ...
 */
Blockly.FieldButton.prototype.setText = function(_newText) {
 ...
 * @package
 */
Blockly.FieldButton.prototype.markDirty = function() {
  this.isDirty_ = true;
  this.constants_ = null;
};
 ...
 * @package
 */
Blockly.FieldButton.prototype.forceRerender = function() {
  this.isDirty_ = true;
 ...
 */
Blockly.FieldButton.prototype.setValue = function(newValue) {
  var doLogging = false;
  if (newValue === null) {
 ...
 * @private
 */
Blockly.FieldButton.prototype.processValidation_ = function(newValue,
    validatedValue) {
 ...
 */
Blockly.FieldButton.prototype.doClassValidation_ = function(opt_newValue) {
 ...
 * @protected
 */
Blockly.FieldButton.prototype.doValueUpdate_ = function(newValue) {
 ...
 * @protected
 */
Blockly.FieldButton.prototype.doValueInvalid_ = function(_invalidValue) {
  // NOP
};
 ...
 * @protected
 */
Blockly.FieldButton.prototype.getClickTarget_ = function() {
 ...
 * @protected
 */
Blockly.FieldButton.prototype.getAbsoluteXY_ = function() {
 ...
 * @package
 */
Blockly.FieldButton.prototype.referencesVariables = function() {
  return false;
};
 ...
 * @package
 */
Blockly.FieldButton.prototype.getParentInput = function() {
 ...
 */
Blockly.FieldButton.prototype.getFlipRtl = function() {
  return false;
};
 ...
 */
Blockly.FieldButton.prototype.isTabNavigable = function() {
  return false;
};
 ...
 * @package
 */
Blockly.FieldButton.prototype.onBlocklyAction = function(_action) {
  return false;
};
 ...
 * @package
 */
Blockly.FieldButton.prototype.setCursorSvg = function(cursorSvg) {
  if (!cursorSvg) {
    this.cursorSvg_ = null;
    return;
  }
 ...
 * @package
 */
Blockly.FieldButton.prototype.setMarkerSvg = function(markerSvg) {
  if (!markerSvg) {
    this.markerSvg_ = null;
    return;
  }
 ...
 * @protected
 */
Blockly.FieldButton.prototype.updateMarkers_ = function() {
...
Blockly.FieldButton.prototype.showEditor_ = function() {
    this.clickHandler_.call(this);
};

Blockly.FieldButton.prototype.setDisabled = function(bool){
    if(bool){
        Blockly.utils.dom.addClass(this.fieldGroup_, 'disabled');
    }else{
        Blockly.utils.dom.removeClass(this.fieldGroup_, 'disabled');
    }
}

Blockly.fieldRegistry.register('field_button', Blockly.FieldCheckbox);