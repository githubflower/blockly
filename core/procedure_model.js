 ...
 * @constructor
 */
Blockly.ProcedureModel = function(workspace, name, opt_id) {
  /**
 ...
 */
Blockly.ProcedureModel.prototype.getId = function() {
  return this.id_;
};

/**
 * A custom compare function for the ProcedureModel objects.
 * @param {Blockly.ProcedureModel} var1 First variable to compare.
 * @param {Blockly.ProcedureModel} var2 Second variable to compare.
 * @return {number} -1 if name of var1 is less than name of var2, 0 if equal,
 *     and 1 if greater.
 * @package
 */
Blockly.ProcedureModel.compareByName = function(var1, var2) {
