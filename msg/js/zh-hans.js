...
Blockly.Msg["LOCATION_START"] = "起始点";
Blockly.Msg["LOCATION_END"] = "结束点";
Blockly.Msg["TARGET_POINT"] = "目标点";
Blockly.Msg["RISE_HEIGHT"] = "抬升高度";
Blockly.Msg["MOVE_DOOR"] = "门形运动";
Blockly.Msg["MOVE_DOOR_TOOLTIP"] = "机器人先运动到当前点上方某高度，再移到目标点上方某高度，最后移动到目标点";

Blockly.Msg["TRIGGER_TYPE"] = "触发类型";
Blockly.Msg["TRIGGER_TYPE_TIME_PERCENT"] = "按时间百分比";
Blockly.Msg["TRIGGER_TYPE_TIME"] = "按时间";
Blockly.Msg["TRIGGER_TYPE_DISTANCE_PERCENT"] = "按距离百分比";
Blockly.Msg["TRIGGER_TYPE_DISTANCE"] = "按距离";
Blockly.Msg["TRIGGER_RELATIVE"] = "触发参考点";
Blockly.Msg["TRIGGER_RELATIVE_START_POINT"] = "以起始点为参考点";
Blockly.Msg["TRIGGER_RELATIVE_END_POINT"] = "以结束点为参考点";
Blockly.Msg["TRIGGER_RELATIVE_THE_POINT"] = "以特殊点为参考点";
Blockly.Msg["TRIGGER_VALUE_DESC"] = "触发点数值";
Blockly.Msg["TRIGGER_IO"] = "触发IO";
Blockly.Msg["TRIGGER_IO_STATUS"] = "触发设置IO状态";
Blockly.Msg["IO_INDEX_DESC"] = "IO索引";
Blockly.Msg["ADD_TRIGGER"] = "增加触发器";
Blockly.Msg["DELETE_TRIGGER"] = "删除触发器";
Blockly.Msg["TRIGGER"] = "触发器";
Blockly.Msg["TRIGGERING"] = "触发";
Blockly.Msg["TRIGGER_TOOLTIP"] = "创建触发器对象";
Blockly.Msg["GET_LOCATION_HERE"] = "获取当前点";
Blockly.Msg["SET_SLEEP"] = "设置延时";
Blockly.Msg["SLEEP_TIMES"] = "秒";
Blockly.Msg["NEW_TOOL"] = "工具坐标系";
Blockly.Msg["TOOLS"] = "工具坐标系";
Blockly.Msg["ROBOT_GET_TOOL"] = "获取工具坐标系";
Blockly.Msg["ROBOT_SET_TOOL"] = "设置工具坐标系";
Blockly.Msg["TOOL_OBJ"] = "工具坐标系对象";
