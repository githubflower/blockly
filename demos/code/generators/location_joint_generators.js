Blockly.Lua['set_location_joint'] = function(block) {
  ...
  var code = 'local ' + text_location_name + ' = ' + 'LocationJoint.new()\n' + 
             text_location_name + '.j1' + ' = ' + value_location_angle1 + '\n' +
             text_location_name + '.j2' + ' = ' + value_location_angle2 + '\n' +
             text_location_name + '.j3' + ' = ' + value_location_angle3 + '\n' +
             text_location_name + '.j4' + ' = ' + value_location_angle4 + '\n' +
             text_location_name + '.j5' + ' = ' + value_location_angle5 + '\n' +
             text_location_name + '.j6' + ' = ' + value_location_angle6 + '\n' +
             text_location_name + '.j7' + ' = ' + value_location_angle7 + '\n' +
             text_location_name + '.j8' + ' = ' + value_location_angle8 + '\n' +
             text_location_name + '.j9' + ' = ' + value_location_angle9 + '\n';
  return code;
};
